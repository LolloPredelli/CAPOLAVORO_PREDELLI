...
# rules set updated (new logic dependencies supported and fixed some rules updated)    
# improved building elements feature
# json conversion featured with relative functions
...
# constants
TEXT_URL = "develop/Backend/stable/input/text.txt"
RESULT_URL = "develop/Backend/stable/output/result.json"
...
class Element:
    def __init__(self, id=None, type=None, link=None, dep=None):
...
map_structure = {"title" : title, "branches" : []}
...
# Step 6: Convert elements into a JSON structure
    ...
    map_structure['branches'].append(json_structure)
    print("DEBUG: JSON structure created")

# Step 7: Create JSON file
with open(RESULT_URL, 'w') as f:
    json.dump(map_structure, f, indent=4)
    print("DEBUG: JSON file created")
